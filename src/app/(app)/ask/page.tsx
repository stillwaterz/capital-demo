    ...
    <div className="space-y-4">
      <section>
        ...
        <p className="text-base text-muted-foreground mt-1">
          Ask anything about your portfolio or the markets. MarketLink answers in plain Zambian-context English.
        </p>
        <div className="mt-3 grid grid-cols-2 gap-2">
          {["Why did Zambeef move today?", "What is the current BoZ rate?", "How do share dividends work?", "Compare CEC and ATEL"].map((q) => (
            <a
              key={q}
