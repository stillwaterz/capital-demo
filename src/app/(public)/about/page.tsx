    ...
    <div className="max-w-2xl space-y-10">
      <section>
        ...
        <p className="text-lg text-muted-foreground mt-3 leading-relaxed">
          MarketLink is an AI-native investment platform built for Zambian retail and diaspora investors. We make the Lusaka Securities Exchange accessible to anyone with a phone.
        </p>
      </section>
      ...
      <section className="space-y-4">
        ...
        <p className="text-base text-muted-foreground leading-relaxed">
          We give ordinary Zambians access to LuSE equities - the same shares that institutions and high-net-worth investors have traded for decades. Through AI-powered research, daily briefings and plain-English explanations, we help you understand what you own and why it moves.
        </p>
        <p className="text-base text-muted-foreground leading-relaxed">
      ...
      <section className="space-y-4">
        ...
        <ul className="space-y-2 text-base text-muted-foreground">
          ...
          <li>Withholding Tax (WHT) on dividends is applied at source at the rate set by ZRA.</li>
